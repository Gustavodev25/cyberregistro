      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-neutral-50">
          <div className="px-6 py-8 flex flex-col gap-4">
            <div>
              <h1 className="text-2xl font-semibold text-neutral-900">BPP ML</h1>
              ...
              <div className="relative">
                ...
                <div className="mt-6 grid lg:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.15s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">1</div>
                      <div>
                    ...
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">2</div>
                      <div>
                    ...
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.25s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">3</div>
                      <div>
                    ...
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">4</div>
                      <div>
                    ...
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.35s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">5</div>
                      <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">6</div>
                      <div>
                    ...
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.45s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">7</div>
                      <div>
                    ...
                    <div className="flex gap-3 items-start rounded-xl border border-neutral-200 bg-white p-4 animate-fade-in" style={{ animationDelay: '0.5s' }}>
                      <div className="h-8 w-8 rounded-full bg-neutral-900 text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">8</div>
                      <div>
                ...
                <div className="mt-8 flex items-center justify-center">
                  <a
                    ...
                    className="group px-8 py-3.5 bg-neutral-900 text-white rounded-xl hover:bg-neutral-800 transition-all hover:shadow-xl hover:scale-[1.02] font-semibold"
                  >
